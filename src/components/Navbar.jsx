import { CgProfile, CgHeart,CgLogOut } from 'react-icons/cg';
...
const Navbar = () => {
  ...
  return (
    <div className="h-[50px] px-4 w-full font-light z-20 text-[15px] sm:px-10 sm:text-sm xl:text-lg">
      <div className="h-[50px] flex  sm:grid-cols-3 ">
        ...
        <div className="relative shrink-1 w-full h-full flex justify-start sm:justify-center  ">
          <Link to="/">
            <img src={logo} alt="H & M" className="absolute py-4 h-full text-start" />
          </Link>
        </div>
        <div className="h-full w-full flex-1 md:text-sm xl:text-md">
          <div className="w-full h-full flex flex-row justify-end items-center">
            ...
            {currentUser ?
              <div className="flex flex-row">
                ...
                >
                  <div className="pl-2 float-none" ><CgLogOut /></div>
                  <p>Logout</p>
                </Link>
              </div> :
